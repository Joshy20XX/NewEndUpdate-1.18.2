...
package net.mcreator.thenewendupdateforge.world.dimension;
...
public class NewEndBiomeDimension {
	...
	public static class Fixers {
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("the_new_end_update__forge:new_end_biome"), customEffect));
		}
	}
}
