...
import net.mcreator.thenewendupdateforge.item.NewEndBiomeItem;
...
public class TheNewEndUpdateForgeModItems {
	...
	public static final RegistryObject<Item> NEW_END_BIOME = REGISTRY.register("new_end_biome", () -> new NewEndBiomeItem());
